      ...
      <header className="flex flex-col sm:flex-row justify-between items-center max-w-7xl mx-auto px-6 py-4 bg-black shadow-md sticky top-0 z-10">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <div
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-md cursor-pointer bg-orange-500 hover:bg-orange-600 text-black transition select-none text-sm sm:text-base"
            title="Logout"
          >
            <IoIosLogOut size={24} />
